...
!define GROUPNAME "Aquachain"
!define HELPURL "https://github.com/aquachain/mist/releases/issues"
!define UPDATEURL "https://github.com/aquachain/mist/releases"
!define ABOUTURL "https://aquachain.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Aquachain"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gaqua incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gaqua\unpacked\aquachain.exe" "" "" "Aquachain" 30303 "" "" ""
    #SimpleFC::AdvAddRule "Gaqua outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gaqua\unpacked\aquachain.exe" "" "" "Aquachain" "" 30303 "" ""
    #SimpleFC::AdvAddRule "Gaqua UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gaqua\unpacked\aquachain.exe" "" "" "Aquachain" "" 30303 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Gaqua incoming peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Gaqua outgoing peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Gaqua UDP discovery (UDP:30303)"
